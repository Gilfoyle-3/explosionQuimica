...
socket.on('joined_waiting_room', ({ id }) => {
  ...
  if (waitingView && !document.getElementById('game-rules-box')) {
    ...
    rulesBox.innerHTML = `
      ...
      <p style="margin-bottom: 6px;">• <b>Cartas Especiales:</b> 🌪️ <b>Tornado</b> y 💣 <b>Bomba</b>.</p>
      <p style="color: var(--cyber-yellow); margin-top: 8px; text-align: center;">⏳ Esperando a que el creador inicie la partida...</p>
    `;
